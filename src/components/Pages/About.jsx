...
const About = () => {
    return (
        <div>
            <Abouthero />
            <div className='flex flex-row w-4/5 justify-between mx-auto gap-14 items-center mt-6 mb-6'>
                <div>
            ...
            <div className='flex flex-row justify-between mx-auto w-4/5 pt-20 pb-20'>
            ...
            <div>
                ...
                <div className='flex flex-row gap-7 justify-center pt-28 pb-28'>
                    <div className=' mb-28'>
                        <Usercard />
                    </div>
                    <div>
